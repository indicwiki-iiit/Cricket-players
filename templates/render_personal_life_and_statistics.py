# Displays personal life and statistical analysis for a given player based on his/her information.
...
def main2(_id):
    return render(_id, template="./templates/personal_life.j2")

def main4(_id):
    return render(_id, template="./templates/player_statistical_analysis.j2")
